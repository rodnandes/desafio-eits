 ...
 */
@Entity(ejbName = "UsuarioBean", dataSourceName = "cgDataSource", tableName = "UsuarioBean", primKeyClass = "java.lang.Integer")
@JndiName(local = "ejb.UsuarioBeanLocalHome")
...
abstract public class UsuarioBean extends GenericEntityBean implements
		EntityBean {
	/**
